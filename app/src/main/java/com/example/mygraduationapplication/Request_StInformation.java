...
public class Request_StInformation extends AsyncTask<String, Void, String> {

    private String result_info;

    private static final String TAG = "Request_StInformation";
    ...
    protected String doInBackground(String... params) {
        ...
        String parsingURL = "http://openapi.gbis.go.kr/ws/rest/busrouteservice/station?"
