...
public class Request_SearchSt extends AsyncTask<String, Void, String> {

    private String result_info;

    private static final String TAG = "Request_SearchSt";

    @Override
    protected String doInBackground(String... params) {

        String station_name = (String) params[0];
        String xml_parsing = (String) params[1];

        String parsingURL = "http://openapi.gbis.go.kr/ws/rest/busstationservice?"
        ...
        String location = URLEncoder.encode(station_name);//한글의 경우 인식이 안되기에 utf-8 방식으로 encoding     //지역 검색 위한
