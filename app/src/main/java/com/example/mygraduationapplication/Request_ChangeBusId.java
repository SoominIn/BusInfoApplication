...
public class Request_ChangeBusId extends AsyncTask<String, Void, String> {

    private String result_info;

    private static final String TAG = "Request_EntireBusList";

    @Override
    protected String doInBackground(String... params) {

        String route_id = (String) params[0];
        String xml_parsing = (String) params[1];

        String parsingURL = "http://openapi.gbis.go.kr/ws/rest/busrouteservice/info?"
                + "serviceKey=7GwSGhRq1iv50FQdSEcZ4LLVY6EV5z8m2iZnJ%2BnJzrl9sGt2tdY2nbvMKOQ%2BiuSQgpoZsolONKLzM8%2FIbrZ7%2BQ%3D%3D"
                + "&routeId=" + route_id;

        StringBuffer buffer = new StringBuffer();

        String location = URLEncoder.encode(route_id);//한글의 경우 인식이 안되기에 utf-8 방식으로 encoding     //지역 검색 위한
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                switch (eventType) {
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if (tag.equals("busRouteInfoItem")) ;// 첫번째 검색결과
                    ...
                    case XmlPullParser.END_TAG:
                        ...
                        if (tag.equals("busRouteInfoItem")) buffer.append("\n"); // 첫번째 검색결과종료..줄바꿈
                        break;
                }
