...
public class Request_EntireBusList extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String parsingURL = "http://openapi.gbis.go.kr/ws/rest/busarrivalservice/station?"
        ...
        String location = URLEncoder.encode(station_id);//한글의 경우 인식이 안되기에 utf-8 방식으로 encoding
