...
public class Mysql_Service_CurrentStation extends AsyncTask<String, Void, String> {    // 버스 이름, 버스가 경유하는 정류장 목록
    ...
    protected String doInBackground(String... params) {
        ...
        String st_name = (String)params[1];
        ...
        String postParameters = "st_name=" + st_name + "&bus_region=" + bus_region;
